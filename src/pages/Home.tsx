      ...
      <main className="flex-1 flex flex-col w-full">
        {isLoading ? (
          ...
          <>
            ...
            <section id="about" className="w-full min-h-screen bg-card flex flex-col items-center justify-center">
              <h2 className="text-3xl md:text-5xl font-bold text-primary tracking-tight">About Section</h2>
            </section>

            {/* Projects Section */}
            <section id="projects" className="w-full min-h-screen bg-background flex flex-col items-center justify-center">
              <h2 className="text-3xl md:text-5xl font-bold text-primary tracking-tight">Projects Section</h2>
            </section>

            {/* Tech Stacks Section */}
            <section id="tech" className="w-full min-h-[70vh] bg-card flex flex-col items-center justify-center">
              <h2 className="text-3xl md:text-5xl font-bold text-primary tracking-tight">Tech Stacks</h2>
            </section>
